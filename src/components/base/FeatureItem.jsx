...
const FeatureItem = ({ feature }) => {
  return (
    <article key={feature.id} className="flex-1 text-center flex flex-col sm:flex-row lg:flex-col sm:gap-12 items-center lg:items-start md:odd:px-12 lg:odd:px-0 lg:even:pt-12">
      ...
      <div className="mt-8 max-w-sm sm:mt-0 sm:text-left">
        <h2 className="text-preset-4 text-primary-neutral-000">{feature.title}</h2>
